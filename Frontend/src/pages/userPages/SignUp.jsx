            ...
            {signUpCorrect ? (
                <div>
                    <div>
                        <h1 className="text-sky-600 font-black text-6xl capitalize text-center">
                            <span style={{ color: "#00ADB5" }}>Validate</span>{" "}
                            your account
                        </h1>
                ...
                <>
                    <h1 className="text-sky-600 font-black text-5xl capitalize">
                        ...
                        <span style={{ color: "#00ADB5" }}>recipes</span>
                    </h1>
                        ...
                        <div className="my-2">
                            ...
                            {isUsernameFocused && (
                                <Info
                                    info={{
                                        msgInfo:
                                            "Your username must be 3 to 20 characters long, start and end with a letter or number, include underscores (no consecutive ones).",
                                    }}
                                />
                            )}
                            <input
